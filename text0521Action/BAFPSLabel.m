...
+ (instancetype)showInWindow:(UIWindow *)window
{
    ...
    NSLayoutConstraint *leadingLayout =[NSLayoutConstraint constraintWithItem:label
                                                                   ...
                                                                   multiplier:1
                                                                     constant:10.f];
    NSLayoutConstraint *topLayout = [NSLayoutConstraint constraintWithItem:label
    ...
    NSLayoutConstraint *heightLayout = [NSLayoutConstraint constraintWithItem:label
                                                                   ...
                                                                   multiplier:0
                                                                     constant:20.f];
    if (IOS8_OR_LATER) {
        [NSLayoutConstraint activateConstraints:@[leadingLayout, topLayout, widthLayout, heightLayout]];
    }
    else {
        [window addConstraints:@[leadingLayout, topLayout, widthLayout, heightLayout]];
    }
